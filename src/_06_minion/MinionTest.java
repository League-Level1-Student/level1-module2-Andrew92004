/*block commented for now cuz it was causing errors for erlier lessons
 * block commented for now cuz it was causing errors for erlier lessons
 * block commented for now cuz it was causing errors for erlier lessons
 * block commented for now cuz it was causing errors for erlier lessons
 * block commented for now cuz it was causing errors for erlier lessons
 ...
 * 
 * 
 * Copyright (c) The League of Amazing Programmers 2013-2019 Level 1
 * 
 * 
 * 
 ...
 * variables of the Minion class. If they’re done right, all these tests will
 * pass.
 * 
 ...
 * dave.getColor()); }
 * 
 * @Test public void testSetters() { Minion stuart = new Minion("Stuart", 1,
 * "yellow", "");
 * 
 * stuart.setMaster("T. Rex"); assertEquals("T. Rex", stuart.getMaster());
 * 
 * stuart.setMaster("Napoleon"); assertEquals("Napoleon", stuart.getMaster()); }
 * 
 * }
 * 
 * 
